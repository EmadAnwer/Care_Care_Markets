...
public class HomeServiceProviderRecyclerViewAdapter extends RecyclerView.Adapter<HomeServiceProviderRecyclerViewAdapter.ViewHolder> implements View.OnClickListener{
    ...
    public HomeServiceProviderRecyclerViewAdapter(List<ServiceProviders> governorateArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.service_provider_layout,parent,false);
    ...
    public static class ViewHolder  extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            serviceProviderCoverImageView =itemView.findViewById(R.id.serviceProviderHomeCoverImageView);

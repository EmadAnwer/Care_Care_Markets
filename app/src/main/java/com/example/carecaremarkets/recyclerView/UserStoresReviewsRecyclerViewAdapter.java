...
public class UserStoresReviewsRecyclerViewAdapter extends RecyclerView.Adapter<UserStoresReviewsRecyclerViewAdapter.ViewHolder> implements View.OnClickListener {
    SharedPreferences pref;
    //var
    private final List<UserSR> userSPRList;
    Context context;


    public UserStoresReviewsRecyclerViewAdapter(List<UserSR> userSPRList, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.deleteReviewTextView.setTag(userSPRList.get(position).store_id);
